    ...
    const linkSections = [
        ...
        },
        {
            ...
            links: [
                ...
                { text: "Política de Privacidad", path: '/', icon: null },
                { text: "Hacerse Miembro Plus", path: '/pricing', icon: null },
        ...
        },
        {
            title: "CONTACTO",
            links: [
                { text: "+54695931", path: '/', icon: MailIcon },
                { text: "ortegasorzanodariel@gmail.com", path: '/', icon: PhoneIcon },
                { text: "La Habana, Cuba 10400", path: '/', icon: MapPinIcon }
            ]
        }
    ];
            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        ...
                        <p className="max-w-[410px] mt-6 text-sm">Bienvenido a gocart, tu destino definitivo para los últimos y más inteligentes gadgets. Desde smartphones y smartwatches hasta accesorios esenciales, te traemos lo mejor en innovación, todo en un solo lugar.</p>
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2025 © DarielDev Todos los derechos reservados.
                </p>
            </div>
        </footer>
    );
