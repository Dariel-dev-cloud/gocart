...
const OurSpecs = () => {
    ...
    return (
        <div className='px-6 my-20 max-w-6xl mx-auto'>
            <Title visibleButton={false} title='Nuestras Especificaciones' description="Ofrecemos servicio y conveniencia de primer nivel para garantizar que tu experiencia de compra sea fluida, segura y completamente sin complicaciones." />
